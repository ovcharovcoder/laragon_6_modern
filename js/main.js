...
const translations = {
  en: {
    ...
    download_btn: 'Download build (330 MB)',
    format: 'Format',
    size_label: 'Size',
  ...
  uk: {
    ...
    download_btn: 'Завантажити збірку (330 MB)',
    format: 'Формат',
    size_label: 'Розмір',
    ...
    copyright: '© 2026 Laragon 6.0 Modern Build — Andrii Ovcharov.',
    legal_html: `Ця збірка використовує стороннє програмне забезпечення: <a href="https://laragon.org/" target="_blank">Laragon</a> (© Le Ngoc Khoa), <a href="https://httpd.apache.org/" target="_blank">Apache HTTP Server</a>, <a href="https://www.php.net/" target="_blank">PHP 8.5.6 / 8.4.19 / 8.3.30</a>, <a href="https://www.phpmyadmin.net/" target="_blank">phpMyAdmin</a>. <p>Усі торгові марки та авторські права належать їхнім відповідним власникам. Метою створення цієї збірки є надання одного з варіантів організації роботи Laragon 6.0 та оновлення його пакетів до сучасного стану. <b>Це не офіційний реліз.</b></p>`,
  },
};
